...
describe('CategoriaHabitacionServices', () => {
  ...
  const nuevaCategoria = {
    ...
    descripcion_categoria: 'Habitación deluxe',
    capacidad: 4,
    precio: 450,
    imagen: 'deluxe.jpg'
  };
  ...
  afterEach(() => {
    // Asegura que no haya solicitudes pendientes
    httpMock.verify();
  });
  ...
  it('debe insertar una categoría (POST con FormData)', () => {
    ...
    formData.append('nombre', nuevaCategoria.nombre_categoria);
    formData.append('descripcion', nuevaCategoria.descripcion_categoria);
